...
@RestController
@RequestMapping("/api/omex-gate-kafka")
public class OmexGateKafkaResource {
    private final Logger log = LoggerFactory.getLogger(OmexGateKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public OmexGateKafkaResource(KafkaProperties kafkaProperties) {
